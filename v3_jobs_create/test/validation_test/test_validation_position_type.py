...
from v3_jobs_create.schemas_validation.schemas_position_type import request_position_type
...
@allure.title("Тест на валидацию Квалификация: brokerId = {broker_id}, biztalkId = {biztalk_id}")
