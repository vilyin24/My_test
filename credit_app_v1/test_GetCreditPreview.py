...
@allure.step(" GetCreditPreview GET-запрос ")
def get_programs(biztalk_id):
    url = f"{Config.BASE_URL_CREDIT}/GetCreditPreview/{biztalk_id}"
    response = requests.get(url, verify=False)
    return response

@allure.feature("GET GetCreditPreview")
@allure.title("Получения информации о минимальной и максимальной сумме кредита для всех категорий,")
@allure.description("GetCreditPreview GET-запрос возвращающий минимальную и максимальную сумму кредита для всех категорий, и минимальную ставку  по biztalkId")
